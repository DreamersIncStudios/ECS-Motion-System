...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Projectile1"",
                    ""type"": ""Button"",
                    ""id"": ""6153387c-6c75-45b7-94db-dbc1085673ee"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                ...
                {
                    ""name"": ""ProjectileChangePos"",
                    ""type"": ""Button"",
                    ""id"": ""2ba03f06-6a18-4711-a7c7-e113e62ac469"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                ...
                {
                    ""name"": ""ProjectileChangeNeg"",
                    ""type"": ""Button"",
                    ""id"": ""667cca79-0144-4b83-b503-8c115d863d7c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""d9e1732f-2641-452e-b257-ea3caae195fe"",
                ...
                {
                    ""name"": """",
                    ""id"": ""01b8591d-2748-4182-9464-41c481b0f1ce"",
                    ""path"": ""<Gamepad>/buttonEast"",
                    ""interactions"": ""Hold"",
                    ""processors"": """",
                    ""groups"": "";Xbox;Dual Sense"",
                ...
                {
                    ""name"": """",
                    ""id"": ""8d90b507-d60b-4786-9a7f-2e8dd2a0119a"",
                    ""path"": ""<Gamepad>/dpad/right"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Xbox;Dual Sense"",
                    ""action"": ""ProjectileChangePos"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""98262f5c-dbb9-437c-acbf-55324a8f1f82"",
                    ""path"": ""<Gamepad>/dpad/left"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Xbox;Dual Sense"",
                    ""action"": ""ProjectileChangeNeg"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_PlayerController_Projectile1 = m_PlayerController.FindAction("Projectile1", throwIfNotFound: true);
        ...
        m_PlayerController_ProjectileChangePos = m_PlayerController.FindAction("ProjectileChangePos", throwIfNotFound: true);
        m_PlayerController_ProjectileChangeNeg = m_PlayerController.FindAction("ProjectileChangeNeg", throwIfNotFound: true);
        // Pause Menu
    ...
    ~@PlayerControls()
    {
        UnityEngine.Debug.Assert(!m_PlayerController.enabled, "This will cause a leak and performance issues, PlayerControls.PlayerController.Disable() has not been called.");
        ...
        UnityEngine.Debug.Assert(!m_MagicController.enabled, "This will cause a leak and performance issues, PlayerControls.MagicController.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_PlayerController_Projectile1;
    ...
    private readonly InputAction m_PlayerController_ProjectileChangePos;
    private readonly InputAction m_PlayerController_ProjectileChangeNeg;
    public struct PlayerControllerActions
    {
        ...
        public InputAction @Projectile1 => m_Wrapper.m_PlayerController_Projectile1;
        ...
        public InputAction @ProjectileChangePos => m_Wrapper.m_PlayerController_ProjectileChangePos;
        public InputAction @ProjectileChangeNeg => m_Wrapper.m_PlayerController_ProjectileChangeNeg;
        ...
        public void AddCallbacks(IPlayerControllerActions instance)
        {
            ...
            @Projectile1.started += instance.OnProjectile1;
            @Projectile1.performed += instance.OnProjectile1;
            @Projectile1.canceled += instance.OnProjectile1;
            ...
            @ProjectileChangePos.started += instance.OnProjectileChangePos;
            @ProjectileChangePos.performed += instance.OnProjectileChangePos;
            @ProjectileChangePos.canceled += instance.OnProjectileChangePos;
            @ProjectileChangeNeg.started += instance.OnProjectileChangeNeg;
            @ProjectileChangeNeg.performed += instance.OnProjectileChangeNeg;
            @ProjectileChangeNeg.canceled += instance.OnProjectileChangeNeg;
        }
    ...
    public interface IPlayerControllerActions
    {
        ...
        void OnProjectile1(InputAction.CallbackContext context);
        ...
        void OnProjectileChangePos(InputAction.CallbackContext context);
        void OnProjectileChangeNeg(InputAction.CallbackContext context);
    }
